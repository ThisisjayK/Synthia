...
// Identical form structure to NewProjectModal but pre-populated
// and runs a Supabase update instead of insert.
//
// Props:
//   project   - the existing project object from Supabase
//   onClose   - called on cancel or backdrop click
//   onSuccess - called with the updated project object on save

import { useState } from "react";
import { supabase } from "../supabaseClient";

// ─── Field components (same as NewProjectModal) ───────────────────────────────
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Target User Type */}
        <div style={{ marginBottom: "20px" }}>
          <Label htmlFor="edit-target-user">
            Target user type{" "}
            <span
              style={{ fontSize: "12px", color: "#94A3B8", fontWeight: 400 }}
            >
